...
{
  new (message_memory) first_interfaces::msg::Sphere(_init);
}

void Sphere_fini_function(void * message_memory)
{
  auto typed_message = static_cast<first_interfaces::msg::Sphere *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Sphere_message_member_array[2] = {
  {
    ...
    offsetof(first_interfaces::msg::Sphere, center),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(first_interfaces::msg::Sphere, radius),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Sphere_message_members = {
  ...
  "Sphere",  // message name
  2,  // number of fields
  sizeof(first_interfaces::msg::Sphere),
...
get_message_type_support_handle<first_interfaces::msg::Sphere>()
{
  return &::first_interfaces::msg::rosidl_typesupport_introspection_cpp::Sphere_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, first_interfaces, msg, Sphere)() {
  return &::first_interfaces::msg::rosidl_typesupport_introspection_cpp::Sphere_message_type_support_handle;
}
