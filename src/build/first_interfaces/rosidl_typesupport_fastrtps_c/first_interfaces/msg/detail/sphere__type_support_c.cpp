...
#include "first_interfaces/msg/detail/sphere__rosidl_typesupport_fastrtps_c.h"
...
using _Sphere__ros_msg_type = first_interfaces__msg__Sphere;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const first_interfaces__msg__Sphere * ros_message = static_cast<const first_interfaces__msg__Sphere *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_first_interfaces__msg__Sphere(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  first_interfaces__msg__Sphere * ros_message = static_cast<first_interfaces__msg__Sphere *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_first_interfaces__msg__Sphere(cdr, ros_message);
}

static uint32_t _Sphere__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_first_interfaces__msg__Sphere(
...
static size_t _Sphere__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_first_interfaces__msg__Sphere(
