...
#include "first_interfaces/msg/detail/num__rosidl_typesupport_fastrtps_c.h"
...
using _Num__ros_msg_type = first_interfaces__msg__Num;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = first_interfaces__msg__Num;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const first_interfaces__msg__Num * ros_message = static_cast<const first_interfaces__msg__Num *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_first_interfaces__msg__Num(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  first_interfaces__msg__Num * ros_message = static_cast<first_interfaces__msg__Num *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_first_interfaces__msg__Num(cdr, ros_message);
}

static uint32_t _Num__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_first_interfaces__msg__Num(
...
static size_t _Num__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_first_interfaces__msg__Num(
