...
bool first_interfaces__msg__sphere__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
...
PyObject * first_interfaces__msg__sphere__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("first_interfaces.msg._sphere");
