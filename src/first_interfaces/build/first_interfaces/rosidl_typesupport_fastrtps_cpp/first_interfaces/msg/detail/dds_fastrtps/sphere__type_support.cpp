...
#include "first_interfaces/msg/detail/sphere__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const first_interfaces::msg::Sphere & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  first_interfaces::msg::Sphere & ros_message)
{
  // Member: center
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = first_interfaces::msg::Sphere;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const first_interfaces::msg::Sphere *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<first_interfaces::msg::Sphere *>(
    untyped_ros_message);
...
{
  return &first_interfaces::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, first_interfaces, msg, Sphere)() {
  return &first_interfaces::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
