...
class AddThreeInts_Event(metaclass=Metaclass_AddThreeInts_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<first_interfaces/AddThreeInts_Request, 1>',
        'response': 'sequence<first_interfaces/AddThreeInts_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['first_interfaces', 'srv'], 'AddThreeInts_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['first_interfaces', 'srv'], 'AddThreeInts_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from first_interfaces.srv import AddThreeInts_Request
    ...
    def response(self, value):
        if self._check_fields:
            from first_interfaces.srv import AddThreeInts_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_AddThreeInts(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'first_interfaces.srv.AddThreeInts')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from first_interfaces.srv import _add_three_ints
...
class AddThreeInts(metaclass=Metaclass_AddThreeInts):
    from first_interfaces.srv._add_three_ints import AddThreeInts_Request as Request
    from first_interfaces.srv._add_three_ints import AddThreeInts_Response as Response
    from first_interfaces.srv._add_three_ints import AddThreeInts_Event as Event
